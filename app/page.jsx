...
const FAQ = [
  ...
  ['What areas do you serve?', <>We&apos;re based in Edmond, OK and serve the entire OKC metro: Oklahoma City, Nichols Hills, Deer Creek, Guthrie, Arcadia, Yukon, Moore, Norman, Midwest City, Piedmont, and Mustang.</>],
...
const FAQ_LD = {
  ...
  mainEntity: [
    ...
    ['What areas do you serve?', 'We are based in Edmond, OK and serve the entire OKC metro: Oklahoma City, Nichols Hills, Deer Creek, Guthrie, Arcadia, Yukon, Moore, Norman, Midwest City, Piedmont, and Mustang.'],
    ['Are you insured and background-checked?', 'Yes. I Connect 4 U LLC is insured and background-checked, with a 4.9-star rating across 300+ installs and three-time Thumbtack Top Pro status.'],
          ...
          <div className="hero">
            <div>
              ...
              <div className="hero-cta">
                ...
                <Link className="btn btn-ghost" href="/#quote">Price my install</Link>
              </div>
              <div className="creds">
            ...
            <div className="hero-art">
              ...
              <div className="note">Based in Edmond, OK · serving Oklahoma City &amp; the surrounding metro. Free quotes on bigger jobs.</div>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="wrap">
            ...
            <div className="reviews">
              ...
              <div className="review" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center' }}>
                ...
                <p>168 real job photos — our trucks, our walls, our wiring. No stock photos.</p>
                <a className="btn btn-ghost" style={{ borderColor: 'var(--amber)', color: 'var(--ink)' }} href={THUMBTACK_URL} target="_blank" rel="noopener">See project photos</a>
              </div>
        ...
        <section id="areas">
          <div className="wrap">
            <div className="sec-head">
              ...
              <h2>Serving Edmond &amp; the OKC metro</h2>
              <p>Based in Edmond — we come to you across the metro, usually within the week.</p>
            </div>
            <div className="areas">
              ...
              {['Nichols Hills','Deer Creek','Guthrie','Arcadia','Yukon','Moore','Norman','Midwest City','Piedmont','Mustang'].map(c => <span className="area" key={c}>{c}</span>)}
            </div>
          </div>
        </section>
        ...
        <section id="pricing">
          <div className="wrap">
            <div className="sec-head">
              <div className="eyebrow">TV Mounting Prices</div>
              <h2>Three ways to mount — pick your finish</h2>
              <p>Upfront pricing, no surprises. Every TV is hung level and secure — the difference is how the wires disappear.</p>
            </div>
            <div className="tiers">
              <div className="tier">
                <div className="body">
