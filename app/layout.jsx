...
const BUSINESS_LD = {
  ...
  priceRange: '$125 - $299',
  image: 'https://production-next-images-cdn.thumbtack.com/i/498519005501972486/desktop/standard/fullscreen',
  sameAs: [
  ...
  areaServed: ['Edmond','Oklahoma City','Norman','Moore','Midwest City','Del City','Yukon','Mustang','Piedmont','Guthrie','Arcadia','Nichols Hills','The Village','Warr Acres','Bethany','Choctaw','Harrah','Jones','Luther','Newcastle','Tuttle','Blanchard','El Reno','Shawnee','Deer Creek'].map(name => ({ '@type': 'City', name })),
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', name: 'Basic TV Mounting (up to 65", customer\'s mount)', price: '125', priceCurrency: 'USD' },
