      ...
      <div className="wrap">
        <div className="foot">
          ...
          <nav className="foot-links" aria-label="Areas">
            ...
            <Link href="/tv-mounting-norman/">TV Mounting Norman</Link>
          ...
          <nav className="foot-links" aria-label="Company">
            ...
            <Link href="/guides/tv-mounting-cost-oklahoma-city/">TV Mounting Cost Guide</Link>
            <Link href="/guides/hide-tv-wires-in-wall/">Hide TV Wires Guide</Link>
            <Link href="/vlog/">Install Vlog</Link>
